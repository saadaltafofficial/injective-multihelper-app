  ...
  return (
    <>
      <div className="flex justify-center items-center">
        <div className="p-10 rounded-lg w-full max-w-md text-center">
          {/* {injectiveAddress ? (
          <>
            <button
      ...
      <div className="section flex w-full justify-center items-start px-4">
        <div className="left-section flex flex-col justify-center items-center w-full">
          <div className="setion-top mb-4 p-4 bg-[#f0f0ef] w-full rounded-xl">
            {!showGasFeeSection ? (
              <div>
                <div className="mt-5">
                  ...
                  <select
                    ...
                    value={selectedDenom}
                    className="w-full p-2 border rounded-lg text-gray-700 text-sm outline-none"
                  >
                ...
                <div className="mt-4 flex justify-between">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-blue-500 to-teal-400 text-white py-2 px-4 rounded-full hover:from-blue-600 hover:to-teal-500"
                  >
                    Send Tokens
                  </button>
                </div>
              ...
              <div className="section-top bg-[#f0f0ef] w-full rounded-xl">
          ...
          <div className='mt-4 p-4 bg-[#f0f0ef] w-full h-[52vh] rounded-xl '>
